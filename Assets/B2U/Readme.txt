...
Blender has some bugs with wrong scales in parented object chains with multiple scaled objects. If you have 
problems with scales in exported scenes please remove the parent of objects and see if it fixes for you.
...
v2.0.1 HOTFIX
	- Fix Bugs in Light Export from Eevee
